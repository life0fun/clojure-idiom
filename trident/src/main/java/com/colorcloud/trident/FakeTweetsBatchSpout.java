 ...
 * It uses a dataset of 500 english sentences. It has a fixed set of actors and subjects for each tweet.
...
public class FakeTweetsBatchSpout implements IBatchSpout {
	...
	public void emitBatch(long batchId, TridentCollector collector) {
		// batch spout emit batchSize fake tweets for each invocation.
		System.out.println("Spout emits a batch of " + batchSize );
